      ...
      <div className="grid grid-flow-row auto-rows-max justify-center gap-2 ">
        ...
        <div className="stats stats-vertical lg:stats-horizontal shadow text-secondary bg-base-300">
          ...
          <div className="stat">
            ...
            <div className="stat-desc">↘︎ $1000 (1%)</div>
          </div>
          ...
          <div className="stat">
            ...
            <div className="stat-title">Trading Days</div>
        ...
        <div className="stats stats-vertical lg:stats-horizontal shadow bg-base-300">
          <div className="stat">
            ...
            <div className="stat-value">demo-account</div>
            <div className="stat-desc">Created 1 Jan 2023</div>
          </div>
        ...
        <div className="stats stats-vertical lg:stats-horizontal shadow bg-base-300">
          <div className="stat">
            ...
            <div className="stat-title">MT4 Server</div>
            <div className="stat-value">ICMarkets</div>
            <div className="stat-desc">MT4-Server-Demo</div>
          </div>
          ...
          <div className="stat">
            ...
            <div className="stat-title">Funded Plan</div>
            <div className="stat-value">Live</div>
            <div className="stat-desc">Express - 50k</div>
          </div>
        </div>
      </div>
    </main>
